function loopIndices = loopPoints(signal, p)
    ...
    % Consider only frames that are no less than 25dB less than the maximum RMS
    % frame
    ...
    % Code adapted from: https://groups.google.com/forum/#!searchin/comp.soft-sys.matlab/messageid$3Aeebd047.-1@WebX.raydaftYaTP/comp.soft-sys.matlab/QyPmPQcUc1g/4GVrKJctqQgJ
    ...
    loopIndices = [round(finalStart), round(finalEnd)];